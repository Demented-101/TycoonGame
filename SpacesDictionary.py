spaces = [
    ...
    {"name": "Brighton Station",        "action": -1,   "is property": True, "prices": [0], "benefit": 0.9},
    ...
    {"name": "Tesla Power Co",          "action": -1,   "is property": True, "prices": [-1], "benefit": 0.9},
    ...
    {"name": "Hove Station",            "action": -1,   "is property": True, "prices": [0], "benefit": 0.9},
    ...
    {"name": "Falmer Station",          "action": -1,   "is property": True, "prices": [0], "benefit": 0.9},
    ...
    {"name": "Edison Water",            "action": -1,   "is property": True, "prices": [-1], "benefit": 0.9},
    ...
    {"name": "Portslade Station",       "action": -1,   "is property": True, "prices": [0], "benefit": 0.9},
    {"name": "Opportunity Knocks",      "action": 0,    "is property": False},
